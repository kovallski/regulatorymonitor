...
function Settings() {
  ...
  const parseSourceMutation = useMutation({
    mutationFn: apiClient.parseSource,
    onSuccess: (data) => {
      toast({
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                ...
                                disabled={parseSourceMutation.isPending}
                                title="Парсить источник"
                              >
                                <RefreshCw className={cn("h-4 w-4", parseSourceMutation.isPending && "animate-spin")} />
                              </Button>
                              <Button
                                variant="ghost"
                                size="icon"
